...
app.layout = dmc.MantineProvider([
    # Filters Panel
    html.Div([
        html.H3("Filters", style={**styles['panel'], 'fontSize': '18px'}),

        html.Label("Period", style={'marginBottom': '10px'}),
        dmc.Slider(
            id="year-slider",
            value=1850,
            min=1814,
            max=1905,
            marks=[
                {"value": i, "label": str(i)} for i in range(1814, 1906, 20)
            ],
            style={'marginBottom': '20px'}
        ),

        html.Label("Category", style={'marginBottom': '10px'}),
        dmc.MultiSelect(
            id="category-dropdown",
            data=[{"value": cat, "label": cat} for cat in categorylist],
        ...
        html.Label("Author", style={'marginBottom': '10px'}),
        dmc.MultiSelect(
            id="author-dropdown",
            data=[{"value": author, "label": author} for author in authorlist],
        ...
        html.Label("Work", style={'marginBottom': '10px'}),
        dmc.MultiSelect(
            id="title-dropdown",
            data=[{"value": title, "label": title} for title in titlelist],
        ...
        html.Label("Places", style={'marginBottom': '10px'}),
        dmc.MultiSelect(
            id="places-dropdown",
            data=[{"value": place, "label": place} for place in sorted(preprocessed_places['name'].unique())],
    ...
    # Main Content Area
    html.Div([
        html.H3("Map and Results", style=styles['panel']),
        html.Div(id='map-output', style=styles['mapContainer']),
