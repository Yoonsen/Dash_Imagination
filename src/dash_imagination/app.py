...
def update_map(filtered_data_json, view_type, heatmap_intensity, heatmap_radius, heatmap_colorscale,
    ...
    try:
        ...
        if not sample_empty:
            ...
            base_size = marker_size if marker_size is not None else 7  # slider base
            size_range = 70  # moderate absolute band
            scale = 9  # still steeper than earlier, but less extreme
