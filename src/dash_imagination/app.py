...
def update_map(filtered_data_json, view_type, heatmap_intensity, heatmap_radius, heatmap_colorscale,
    ...
    try:
        ...
        if not sample_empty:
            ...
            base_size = marker_size if marker_size is not None else 6  # slider base
            size_range = 90  # wider absolute band
            scale = 12  # steeper multiplicative factor on log scale
